...
public class PreferenceConstants {
	...
	public static final String DESCRIPTION = "Configure your preferences for FixErrorHelper.";
	public static final String ERROR_MESSAGE = "API Key must not be empty.";
	public static final String HELP_MESSAGE = "Enter your OpenAI API Key.";
